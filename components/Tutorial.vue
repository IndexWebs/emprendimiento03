    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Bienvenido a tu Aplicación Nuxt
        </h2>
        <p class="mt-3 text-gray-600">
          Te recomendamos revisar la <a href="https://nuxtjs.org" target="_blank" class="button--doc text-green-500 hover:underline">Documentación de Nuxt</a>, ya seas nuevo o tengas experiencia previa con el framework.<br>
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          Para comenzar, elimina <code class="bg-gray-100 text-sm p-1 rounded border">components/Tutorial.vue</code> y comienza a codificar en <code class="bg-gray-100 text-sm p-1 rounded border">pages/index.vue</code>. ¡Diviértete!
        </p>
      </div>
